...
public class App {
    public static void main(String[] args) {
        ...
        get("/heroes/new", (request, response) -> {
            Map<String, Object> model = new HashMap<>();
            model.put("uniqueId", request.session().attribute("uniqueId"));
            return new ModelAndView(model, "formHero.hbs");
        }, new HandlebarsTemplateEngine());
        ...
        get("/heroes", (request, response) -> {
            ...
            model.put("uniqueId", request.session().attribute("uniqueId"));
            return new ModelAndView(model, "both.hbs");
        }, new HandlebarsTemplateEngine());
        ...
        get("/heroes/:id", (request, response) -> {
            ...
            model.put("uniqueId", request.session().attribute("uniqueId"));
            return new ModelAndView(model, "detailsHero.hbs");
        }, new HandlebarsTemplateEngine());
        ...
        get("/squads/:id", (request, response) -> {
            ...
            model.put("uniqueId", request.session().attribute("uniqueId"));
            return new ModelAndView(model, "detailsSquad.hbs");
        }, new HandlebarsTemplateEngine());
